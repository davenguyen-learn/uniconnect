...
Điểm danh \& Chứng nhận tham gia & \texttt{test\_\allowbreak attendance\_\allowbreak trophy.py} & 6 & Khoảng cách Haversine, sinh \& thẩm định token QR xoay động 30s (HMAC-SHA256), chuẩn hóa mã chứng nhận tham gia hoạt động, chống điểm danh lặp (idempotency), từ chối GPS có sai số $acc > 50$m. \\ \hline
