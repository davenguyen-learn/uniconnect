\chapter{Hiện thực hệ thống trợ lý AI và Gợi ý hoạt động}
...
\section{Kiến trúc Hybrid Context (Ngữ cảnh hỗn hợp)}
...
\section{Hiện thực luồng xử lý gợi ý hoạt động cá nhân hóa}
...
\section{Quy trình vận hành RAG Pipeline của Trợ lý AI}
