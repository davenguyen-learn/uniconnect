\chapter{Hiện thực giao diện người dùng (Frontend)}

\section{Công nghệ và kiến trúc giao diện}
...
\section{Chi tiết các màn hình chức năng cốt lõi}
Dưới đây là chi tiết các màn hình chức năng tiêu biểu đã được hiện thực hóa và vận hành ổn định trên hệ thống:

\subsection{Màn hình Bảng điều khiển và Khám phá Hoạt động (Student Dashboard)}
...
\subsection{Màn hình Chi tiết Hoạt động và Đăng ký tham gia (Activity Details)}
...
\clearpage
\subsection{Màn hình Khởi tạo và Thiết lập Hoạt động (Create Activity)}
...
\subsection{Màn hình Lịch Thông minh và Quản lý Lịch trình (Smart Calendar Schedule)}
...
\clearpage
\subsection{Màn hình Trợ lý Học đường AI Thông minh (AI Assistant Chatbot)}
...
\subsection{Màn hình Cộng đồng và Câu lạc bộ Sinh viên (Student Communities \& Clubs)}
...
\clearpage
\subsection{Màn hình Hồ sơ Cá nhân và Vinh danh Thành tích (Gamification Profile)}
...
\subsection{Màn hình Giấy xác nhận Tham gia Hoạt động (Activity Participation Certificate)}
