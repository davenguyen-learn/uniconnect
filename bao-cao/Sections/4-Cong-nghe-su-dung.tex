...
\section{Công nghệ phía người dùng (Frontend)}
...
\subsection{Ngôn ngữ lập trình TypeScript (TS)}
...
\subsection{Framework thiết kế Tailwind CSS}
...
\subsection{Quản lý trạng thái dữ liệu với TanStack Query}
...
\subsection{Thư viện bản đồ số tương tác Leaflet và Tối ưu hóa hiệu năng}
...
\subsection{Công cụ quản lý Cơ sở dữ liệu SQLAlchemy và Alembic}
...
\subsection{Cơ chế xác thực và bảo mật (JWT và RBAC)}
...
\section{Công nghệ cơ sở dữ liệu và AI}
...
\subsection{Hệ quản trị cơ sở dữ liệu PostgreSQL và pgvector}
...
\subsection{Mô hình nhúng ngôn ngữ (Embedding Models)}
...
\subsection{Kiến trúc RAG (Retrieval-Augmented Generation)}
...
\section{Công nghệ đóng gói và triển khai}
...
\subsection{Công nghệ ảo hóa Docker}
...
\subsection{Công cụ điều phối Docker Compose}
...
\subsection{Quy trình triển khai cục bộ (Local Container Deployment Flow)}
...
\subsection{Kiến trúc triển khai sản xuất với Docker Compose (Production Architecture)}
