\chapter{Danh mục API Endpoints hệ thống}
\label{apd:C}
...
\section{Bảng tổng hợp Giao diện API theo Phân hệ}
...
\texttt{GET} & \texttt{/api/v1/certificates/verify/\{code\}} & Không & Cổng công khai đối soát tính nguyên bản của Giấy chứng nhận tham gia hoạt động. \\ \hline
