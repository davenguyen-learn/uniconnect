...
\begin{enumerate}
    \item \textbf{Text Embedding:} Câu hỏi của người dùng được chuyển đổi thành vector truy vấn 768 chiều thông qua mô hình Embedding của Gemini (\texttt{text-embedding-004}).
