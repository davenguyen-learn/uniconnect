...
\subsection{Cơ sở mật mã học trong xác thực điểm danh: HMAC và mã QR Code xoay theo thời gian}
...
\subsubsection{Nguyên lý mã xác thực HMAC theo bước thời gian (Time-step)}
