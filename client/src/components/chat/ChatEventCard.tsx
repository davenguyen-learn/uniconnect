...
export const ChatEventCard: React.FC<ChatEventCardProps> = ({ card }) => {
  ...
  return (
    <div className="p-3.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm hover:shadow-md hover:border-indigo-300 dark:hover:border-indigo-800 transition duration-200 text-left">
      ...
      <div className="mt-2.5 flex items-center gap-2 flex-wrap">
        {card.ctxhFormatted && (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-bold bg-amber-50 text-amber-700 dark:bg-amber-950/40 dark:text-amber-400 border border-amber-200 dark:border-amber-900/50">
